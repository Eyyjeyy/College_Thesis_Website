...
<head>
    ...
    <link rel="stylesheet" href="<?= $this->config->base_url()?>assets/css/admin.css"/>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="<?= $this->config->base_url('admin/homeadmin')?>">HOME </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $this->config->base_url('admin/aboutadmin')?>">ABOUT US</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $this->config->base_url('admin/galleryadmin')?>">GALLERY</a>
                </li>
                <!-- <li class="nav-item">
                    <a class="nav-link" href="<?= $this->config->base_url('gamewebsite/contact')?>">CONTACT US</a>
                </li> -->
                <li class="nav-item">
                    <a class="nav-link" href="<?= $this->config->base_url('admin/logout')?>">LOGOUT</a>
                </li>
            </ul>
        </div>
    </nav>
